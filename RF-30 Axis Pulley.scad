...
// (in mm)
motor_shaft_diameter = 17;

// (in mm)
toothed_part_length = 7; // [3:30]

// (in mm)
base_height = 18; // [0:30]

// (in mm)
base_diameter = 50;	 // [10:50]
...
screws_disposition = 4; // [0:None, 1:1 screw, 2:2 screws at 90�, 3:3 screws at 120�, 4:4 screws at 90�]
...
GT2_2mm_pulley_dia = tooth_spacing (2,0.354);
...
if ( profile == 12 ) { 
//    translate([0, 0, 26]) cylinder(r1=32.5, r2=30, h=1);
    difference() {
...
//	
				//grub screw hole
				rotate([0,0,22.5])cylinder(r=screw_diameter/2,h=base_diameter/2+1,$fn=100);
			}
		}}
	 }
